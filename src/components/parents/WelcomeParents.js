    ...
    <Fragment>
      ...
      <section class="dashboard">
        <div class="container-fluid">
            <div class="row">
                <MenuParents />
                <main class="dash-main col-md-10 col-sm-9 dash-welcome">
                    <div class="row justify-content-end">
                        <div class="offset-md-2 col-md-8 col-sm-9 col-10 mb-sm-5">
                            <h1 class="title-welcome">¡HOLA!</h1>
                            <p class="subtitle-welcome">Bienvenido al administrador escolar</p>
                        </div>
                    </div>
